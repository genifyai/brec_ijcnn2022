...
class TrainingParser:
    ...
    def parse_dataset(self):
        parser = argparse.ArgumentParser(allow_abbrev=False)
        parser.add_argument('--dataset_code', type=str, help='Selects the dataset to use for the experiment')
    ...
    def parse_dataloader(self):
        parser = argparse.ArgumentParser(allow_abbrev=False)
        parser.add_argument('--dataloader_code', type=str, help='Selects the dataloader to use for the experiment')
